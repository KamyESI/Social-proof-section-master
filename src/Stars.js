...
function Stars(param) {
  return (
    <div className="card bg-violet-100 flex flex-col md:flex-row justify-center items-center mx-8 md:mx-0 p-4 lg:px-8 rounded-md md:justify-between md:w-3/4 md:self-end">
